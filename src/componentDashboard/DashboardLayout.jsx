...
const DashboardLayout = ({ jdmCars, muscleCars, hyperCars, supercarCars, fastCars }) => {
  ...
  const handleSearch = (query) => {
    setSearchQuery(query.toLowerCase()); // Cập nhật query tìm kiếm
  };
  ...
  const filterCars = (cars) =>
    cars.filter((car) => car.name.toLowerCase().includes(searchQuery));
  return (
    <div className="dashboard-layout">
      ...
      <div className="dashboard-content">
        ...
        <button
          ...
          onClick={() => navigate("/schedule")} // Điều hướng tới trang Cart
        >
        </button>
        {/* Nút bấm dẫn tới trang cart */}
        <button
